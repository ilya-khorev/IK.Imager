...
public class ImageUploadedDomainEventHandler: IDomainEventHandler<ImageUploadedDomainEvent>
{
    ...
    public async Task Handle(ImageUploadedDomainEvent domainEvent, CancellationToken cancellationToken)
    {
        ...
        await _publishEndpoint.Publish(new OriginalImageUploadedIntegrationEvent
        {
            ...
            ImageGroup = domainEvent.ImageGroup
        }, cancellationToken);
    }
}
