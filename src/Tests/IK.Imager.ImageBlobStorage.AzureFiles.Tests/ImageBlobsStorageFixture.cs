...
/// </summary>
public sealed class ImageBlobsStorageFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        Settings = new ImageAzureStorageSettings
        {
        ...
        BlobImageRepository = new ImageBlobAzureRepository(
            new OptionsWrapper<ImageAzureStorageSettings>(Settings),
            new AzureBlobClient(connectionString));
    }
