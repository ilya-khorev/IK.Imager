...
/// </summary>
public sealed class ImageMetadataStorageFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        Settings = new ImageMetadataCosmosDbStorageSettings
        {
        ...
        MetadataImageRepository = new ImageMetadataCosmosDbRepository(
            new CosmosDbClient(new OptionsWrapper<ImageMetadataCosmosDbStorageSettings>(Settings), CreateEmulatorClientOptions()));
