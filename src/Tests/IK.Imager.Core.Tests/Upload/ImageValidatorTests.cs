...
namespace IK.Imager.Core.Tests.Upload
{
    ...
    {
        [Fact]
        public void CheckFormat_ExpectedImageFormat_ReturnsValid()
        {
            var optionsMock = new Mock<IOptionsSnapshot<ImageLimitationsSettings>>();
            optionsMock.Setup(x => x.Value).Returns(new ImageLimitationsSettings()
            {
        ...
        [Fact]
        public void CheckSize_SizeWithinThresholds_ReturnsValid()
        {
        ...
        private IOptionsSnapshot<ImageLimitationsSettings> GetSettings()
        {
            var optionsMock = new Mock<IOptionsSnapshot<ImageLimitationsSettings>>();
            optionsMock.Setup(x => x.Value).Returns(new ImageLimitationsSettings()
            {
