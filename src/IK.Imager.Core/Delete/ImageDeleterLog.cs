...
internal static partial class ImageDeleterLog
{
    ...
    [LoggerMessage(EventId = 1202, Level = LogLevel.Debug,
        Message = "Removing the files of image {ImageId}: {ImageName} and thumbnails {ThumbnailNames}.")]
    public static partial void RemovingFiles(this ILogger logger, string imageId, string? imageName, string thumbnailNames);
