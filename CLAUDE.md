...
`Tenancy:Source` defaults to `Header`; see *Tenancy, and why there is no abstraction over identity*. `CosmosDb:ContainerId` is `imagemetadatacontainer-v2` - the suffix is deliberate, see *Storage model*.
